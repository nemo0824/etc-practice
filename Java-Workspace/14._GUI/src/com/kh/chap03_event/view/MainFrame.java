...
public class MainFrame extends javax.swing.JFrame{
	...
	public MainFrame() {
		...
		//plustBtn 클릭시 -> 두개의 정수값을 가져온 후 덧셈연산 결과를 result텍스트 상자에 출력
		...
		//단 , 여기서 생성하고 싶다면 "미완성된 메소드"를 완성시키면서 생성 => 익명 클래스 방식
		
		//minusBtn 클릭 시 => 두개의 정수값을 가져온 후 뺄셈연산 결과를 result 텍스트 박스에 출력.
