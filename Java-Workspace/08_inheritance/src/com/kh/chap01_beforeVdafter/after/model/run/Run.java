package com.kh.chap01_beforeVdafter.after.model.run;

import com.kh.chap01_beforeVdafter.after.model.vo.Desktop;
import com.kh.chap01_beforeVdafter.after.model.vo.SmartPhone;
import com.kh.chap01_beforeVdafter.after.model.vo.Tv;
...
public class Run {
	...
	Desktop d = new Desktop("삼성", "d-01", "삼성데스크탑", 1_500_000,true);
		...
		//스마트폰 객체
		//nrand pCode pName price mobileAgency
