...
public class F_Logical {
	 ...
	 * 
	 * OR 연산자 : 논리값 || 논리값 왼쪽, 오른쪽 논리값중 어느하나라도 TRUE면 최종결과가 TRUE
	 * 
	 * 
	 * 
	 */
	...
	public void method1() {
		...
		// 사용자가 입력한 정수값이 양수 이면서(이고) 짝수 인지 확인하기.

		Scanner sc = new Scanner(System.in);

		System.out.printf("정수값 한개 입력 : ");
		int num = sc.nextInt();
	...
	public void method3() {
		...
		System.out.printf("계속 진행하려면 y 또는 Y를 입력하세요 : ");
		 ...
		 * 두개의 조건중 모두 False일 경우 최종결과 값은 False
		 * 
		 * 
		 */
