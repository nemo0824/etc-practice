...
public class B_StringMethodTest {
	...
	public void method() {
		...
		//2. 문자열.contac(String str) : String
		...
		// => 문자열의 beginIndex의 위치에서 부터 endIndex -1까지의 문자열을 추출해서 리턴
		...
		System.out.println(String.valueOf(11111.343));
	}
