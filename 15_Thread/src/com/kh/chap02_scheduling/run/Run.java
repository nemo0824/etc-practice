...
import com.kh.chap02_scheduling.schedulling.Car;
import com.kh.chap02_scheduling.schedulling.Plane;
import com.kh.chap02_scheduling.schedulling.Tank;
...
public class Run {
	...
	public static void main(String[] args) {
		...
		//시작순서는 우선순위야 다를수 있지만 종료순서는 우선순위(priority)가 높은순으로 끝나게 됨.(항상그렇지 않음)
		//
