...
<body>
	...
	<div class="Login-area">
		...
		<form id="Login-form" action="<%= contextPath %>/login.me" method="">
			<table>
				<tr>
					<th> 아이디 : </th>
	...
	<div class="nav-area" align="center">
		<div class="menu"><a href="<%=contextPath %>/jspproject">HOME</a></div>
		<div class="menu"><a href="<%=contextPath %>/list.no">공지사항</a></div>
		<div class="menu"><a href="<%=contextPath %>/list.bo?/current/page=1">일반게시판</a></div>
