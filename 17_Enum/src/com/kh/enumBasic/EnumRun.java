...
import com.kh.enumBasic.Day3.Day4;

public class EnumRun {
/*
 * Enum => Enumeration(열거)의 약자형.
 * 기존에 사용하던 상수를 정의하는 방법중 final static 와 같은 기능함.
 ...
 */
	...
	public static final String TUESDAY = "TYE";	
	public static final String WENDSDAY = "WEN";	
	public static final String THRSDAY = "THU";	
	 ...
	 * 위처럼 상수를 정의했을때 단점
	 * 1) 가독성 떨어짐
	 * 2) 오타가 났을때 원하는결과가 나오지 않을수 있음.
	 * 3) monday라는 문자열을 저장하고싶을 경우 -> 새롭게 선언해줘야함.
	 * 4) 상수필드가지고 반복문을통해 값을 가져올수없음.
	 * 
	 * 
	 * 
	 */
	...
	public static void main(String[] args) {
		 ...
		 * 상수(enum) 사용하는이유
		 * 1)코드가 간결해져서 가독성이 좋음
		 * 2)데이터 그룹 관리 및 연계관계 표현에 용이함
		 * 		ex)하나의 요일에 해당하는 데이터를 (MON,MONDAY,1,월요일) 하나의 상수필드로 합칠수 있다.
		 * 		ex) true, Y, 1
		 * 3)상수별로 다른메서드를 사용해야할때 쉽게 구현이 가능하다.
		 * 
		 * 
		 * 
		 */
