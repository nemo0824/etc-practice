...
public class E_Comparison {
	...
	/*
	 * 비교연산자 (관계연산자) 두 개의 값을 가지고 비교 비교 연산한 결과가 참일경우 true / 거짓일 경우 false값을 반환 ==> 나중에
	 * 특정 조건을 제시할수 있는 조건문에서 많이 사용할 예정.
	 * 
	 * 크고 작음을 비교 a < b : a가 b보다 작습니까? a > b : a가 b보다 큽니까? a <= : a가 b보다 작거나 같습니까? a
	 * >= b: a가 b보다 크거나 같습니까?
	 * 
	 * 
	 * 일치함을 비교 a == b : a와 b가 같습니까? a ! = b : a와 b가 같지 않습니까?
	 * 
	 */
