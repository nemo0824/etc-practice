...
public class C_DimensionalArray {
	...
	public void method1() {
		 ...
		 * 열에 대해 지정(0행 ~4열) == (0열 ~각 행별 열의크기 -1) ==(0열~ arr[행의 인덱스].length-1)
		 * 
		 * 
		 */
	...
	public void method2() {
		...
		int[][] arr = new int[3][5]; // arr[0][0] ->1 arr[0][1] ->2
	...
	public void method4() {
		/*
		 * 가변 배열 행의 크기는 정해져있으나 각각의 행별로 열의갯수가 정해져 있지않은 상태 이차원배열 == 일차원 배열을 여러개묶은 형태 즉,
		 * 묶여있는 일차원 배열의 길이가 꼭 같을 필요는 없다.
		 * 
		 * 단, 행크기는 생략이 불가, 반드시 지정해야함 열 크기는 생략이가능하다 , 각행의 열의 길이가 변경가능함.
		 * 
		 * 
		 * 
		 * 
...
//		System.out.println(arr[0][2]);
		...
		// 특정 인덱스로 접근하려했기때문에 NullPointerException 발생
	...
	public void method7() {
		// int형 2차원배열을 만들어
		/*
		 * 0번행에는 국어점수를 3개 입력받고 1번행에는 영어점수 3개를 입력받은후 각각 반복문을 활용해서 출력 입력 예시: xx점수를 입력하세요 :
		 * 출력 예시: xx점수 : xx xx xx
		 * 
		 * 
		 */
