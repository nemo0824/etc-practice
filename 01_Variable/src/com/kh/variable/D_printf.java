...
public class D_printf {
	 ...
	 * 
	 * System.out.printf("출력하고자하는 형식", 출력하고자 하는값, ....); => f는 format(형식)을 의미 => 형식에
	 * 맞춰서 값들이 출력되고 끝 (줄바꿈x) => 문자열 안에 그값이 들어갈자리에 다음과같은 형식으로 잡아줘야한다.
	 * 
	 * 
	...
	public void printFtest() {
		...
		System.out.printf("%-5d 진짜로 ? \n", iNum1);// %-5d : 5칸의 공간 중 왼쪽으로(음수) 정렬

		// 실수 테스트
		double dNum = 4.27546789;
		System.out.printf("dNum : %f \n", dNum);

		// %f : 소수점 아래 7번쨰 줄에서 반올림되어 소숫점 아래 6번째 까지만 출력됨.

		System.out.printf("dNUm : %.1f \n", dNum); // dNum : 4.3
		// %.1f : 소숫점 아래 2번쨰 줄에서 반올림되어 소숫점아래 1번째까지만 출력됨
		// . 자릿수로 제어가능.
