 ...
 * set+필드명 =>두 단어를 이어줄때 카멀케이스(낙타등표기법)을 활용하여 메서드명 선언
 */
	public void setName(String name) {
		//매개 변수 : 해당 메소드 호출시 전달되는 값을 받아주기 위한 변수 
		
		//name = name
		//매개변수 name = 매개변수name을 대입하는 형식임.
		// 왜? 필드명과 매개변수명이 동일할경우 {}영역 내에서는 해당영역에서 만들어진 변수가 좀 더 우선순위가 높기때문.
	...
	//모든 필드값을 뽑고싶을때 하나의 문자열로 합쳐서 돌려주는 용도의 메소드
	public String information() {
		//xxx님의 나이는 xx살이고 키는 xx cm입니다.
