...
public class A_Variable {
	...
	System.out.println("임재원 : " + (11000 * 4 * 5) +"웝 입니다. ");
	...
	System.out.println("임재원:" + (pay * time * day)+ "원 입니다 ");
	...
	public void declareVariable() {
		 ...
		 * 3. 해당영역에 선언된 변수는 해당 영역안에서만 사용 가능 (다른 메소드에서는 불가능.)
		 *   => 지역변수라는 개념 
		 * 	
		 * 
		 */
