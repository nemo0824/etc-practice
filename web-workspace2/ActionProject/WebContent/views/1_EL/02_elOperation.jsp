...
<body>
	...
	<!--  request.getAttribute("")로 올때는 object로 와서 형변환해야함 -->
	...
	<p>
		* EL연산 <br>
		...
		pOne은 null입니까? : ${pOne == null } 또는 ${empty pOne } 또는 또는 ${pOne eq null }<br>
	...
	<p>
		* EL연산에서 배운 키워드만 가지고 써보기<br>
		...
		lTwo가 텅비어있지않거나 또는 sOne에 담긴 값이 "안녕하쇼"와 일치합니까? : ${!empty lTwo or sOne eq '안녕하쇼'}
